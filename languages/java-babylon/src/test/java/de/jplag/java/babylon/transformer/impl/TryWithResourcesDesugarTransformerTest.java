...
public class TryWithResourcesDesugarTransformerTest extends TransformerTest {
    @Override
    protected String getFileName() {
        return "TryWithResources.java";
    }

    @Override
    protected TransformationPipeline getPipeline() {
        return pipeline(step(new TryWithResourcesDesugarTransformer()));
    }
