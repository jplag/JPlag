...
public interface GraphPattern {
    ...
    /**
     * Compares this {@link GraphPattern} to another {@link GraphPattern} in order to generate a {@link GraphTransformation} between the two.
     * The type of {@link GraphPattern} determines how the comparison works.
    ...
    /**
     * Adds a newly created {@link NodePattern} to this pattern. This occurs when a {@link GraphTransformation} includes the generation of new {@link Node}s.
     */
    ...
    /**
     * Matches the given candidate {@link Node}s against the respective root {@link NodePattern}s of this {@link GraphPattern}.
    ...
    /**
     * Verifies that the given match of this {@link GraphPattern} is still valid. After a transformation involving the match's {@link Node}s,
