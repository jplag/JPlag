...
public class Edges {
    ...
    /**
     * An assignment expression's left-hand side (LHS).
     */
    ...
    /**
     * An assignment expression's right-hand side (RHS).
     */
    ...
    /**
     * A binary operator's left-hand side (LHS).
     */
    ...
    /**
     * A binary operator's operator code (e.g. "+", "-", "*", "/").
     */
    ...
    /**
     * A binary operator's right-hand side (RHS).
     */
    ...
    /**
     * A call expression's callee (the function being called).
     */
    ...
    /**
     * A call expression's invoked function declaration (if it can be resolved).
     */
    ...
    /**
     * A component's translation units.
     */
    ...
    /**
     * A declaration statement's declarations.
     */
    ...
    /**
     * A field declaration's modifiers (e.g. "public", "private", "static", "final").
     */
    ...
    /**
     * A for statement's initialization statement.
     */
    ...
    /**
     * A for statement's iteration statement.
     */
    ...
    /**
     * A for statement's body statement.
     */
    ...
    /**
     * A function declaration's overridden functions (if it overrides any function).
     */
    ...
    /**
     * A function declaration's overriding functions (if it is overridden by any function).
     */
    ...
    /**
     * A function type's parameter types.
     */
    ...
    /**
     * A function type's return types.
     */
    ...
    /**
     * An if statement's else statement (if it has an else statement).
     */
    ...
    /**
     * An if statement's then statement (the body of the if statement).
     */
    ...
    /**
     * A member expression's record declaration (if it can be resolved to one).
     */
    public static final CpgEdge<MemberExpression, RecordDeclaration> MEMBER_EXPRESSION__RECORD_DECLARATION = new CpgEdge<>(EdgeUtil::getRecord, null,
            ANALYTIC);
    /**
     * A member expression's base expression.
     */
    ...
    /**
     * A method declaration's body statement.
     */
    ...
    /**
     * A method declaration's parameter declarations.
     */
    ...
    /**
     * A method declaration's record declaration.
     */
    ...
    /**
     * A namespace declaration's declarations.
     */
    ...
    /**
     * A node's location in the source code.
     */
    ...
    /**
     * A method declaration's local name.
     */
    public static final CpgAttributeEdge<MethodDeclaration, String> METHOD_DECLARATION__LOCAL_NAME = new CpgAttributeEdge<>(EdgeUtil::getLocalName,
            null);
    /**
     * An object type's record declaration (if it can be resolved to one).
     */
    ...
    /**
     * A record declaration's field declarations.
     */
    ...
    /**
     * A record declaration's method declarations.
     */
    ...
    /**
     * A record declaration's constructor declarations.
     */
    ...
    /**
     * A reference's declaration it refers to.
     */
    public static final CpgEdge<Reference, Declaration> REFERENCE__REFERS_TO = new CpgEdge<>(Reference::getRefersTo, Reference::setRefersTo,
            REFERENCE);
    /**
     * A return statement's return values.
     */
    ...
    /**
     * A statement's local variable declarations.
     */
    ...
    /**
     * A subscript expression's subscript expression (the index).
     */
    ...
    /**
     * A subscript expression's array expression (the expression being indexed).
     */
    ...
    /**
     * A translation unit declaration's declarations.
     */
    ...
    /**
     * A unary operator's input expression.
     */
    ...
    /**
     * A unary operator's operator code (e.g. "!", "-", "++", "--").
     */
    ...
    /**
     * A value declaration's usage references.
     */
    ...
    /**
     * A variable declaration's initializer expression (if it has an initializer).
     */
    ...
    /**
     * A while statement's body statement.
     */
    ...
    /**
     * A do statement's body statement.
     */
     ...
     * @param consumer the consumer to process the edges
