...
public class Edges {
     ...
     */
    private static Map<Class<?>, List<IEdge<?, ?>>> fromType;
    /**
     * A {@link Map} to retrieve all {@link IEdge}s with a specific target type.
     */
    private static Map<Class<?>, List<IEdge<?, ?>>> toType;
    ...
    public static CpgPropertyEdge<IncompleteType, Name> INCOMPLETE_TYPE__NAME = new CpgPropertyEdge<>(IncompleteType::getName, IncompleteType::setName);
