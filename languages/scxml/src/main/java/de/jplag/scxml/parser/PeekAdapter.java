...
/**
 * A parser adapter that provides a way to retrieve a list of
 * token types. When a token is added, only the ordinal of its type
 * is stored. This can be used to "peek" at a list of token types
 * that are extracted when visiting a statechart.
 */
public class PeekAdapter extends ScxmlParserAdapter {
    ...
    /**
     * Lexicographically compares two lists of integer representations /
     * ordinals of token types.
     *
