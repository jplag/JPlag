...
public class JavaLanguageTest extends LanguageModuleTest {
    ...
    protected void collectTestData(TestDataCollector collector) {
        ...
        collector.testFile("ClassWithoutModifierBug.java").testTokenSequence(J_PACKAGE, J_IMPORT, J_IMPORT, J_IMPORT, J_CLASS_BEGIN, J_CLASS_END,
                J_CLASS_BEGIN, J_CLASS_END);
