...
class MinimalDynamicMetamodelTest {
    ...
    @BeforeEach
    public void setUp() {
        language = new DynamicMetamodelLanguage();
    ...
    void testBookstoreMetamodels() throws ParsingException {
        ...
        logger.debug(TokenPrinter.printTokens(result, baseDirectory, Optional.of(DynamicMetamodelLanguage.VIEW_FILE_SUFFIX)));
    ...
    public void tearDown() {
        FileUtil.clearFiles(new File(BASE_PATH.toString()), DynamicMetamodelLanguage.VIEW_FILE_SUFFIX);
    }
}
