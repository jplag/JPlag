...
class ReportTokenPositionTestTest {
    ...
    void testCorrectTokenPositionsInComparisonReport() {
        ...
        CodePosition startInFirst = comparisonReport.matches().getFirst().startInFirst();
        CodePosition endInFirst = comparisonReport.matches().getFirst().endInFirst();
        CodePosition startInSecond = comparisonReport.matches().getFirst().startInSecond();
        CodePosition endInSecond = comparisonReport.matches().getFirst().endInSecond();
