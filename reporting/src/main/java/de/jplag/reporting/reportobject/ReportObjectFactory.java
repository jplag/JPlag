...
public class ReportObjectFactory {
    ...
    private static final Path SECONDARY_METRICS_FILE_NAME = Path.of("secondaryMetrics.json");
    ...
    private void writeOptionsFiles(JPlagOptions options) {
        ...
        resultWriter.addJsonEntry(secondaryMetrics, SECONDARY_METRICS_FILE_NAME);
    }
