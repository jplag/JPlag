...
import de.jplag.reporting.reportobject.model.ReportInformation;
...
public class ReportObjectFactory {
    ...
    private static final Path REPORT_INFORMATION_FILE_NAME = Path.of("reportInformation.json");
    ...
    private void writeOptionsFiles(JPlagOptions options) {
        ...
        List<String> secondaryMetrics = new ArrayList<>(List.of("MAX", "LONGEST_MATCH", "MAXIMUM_LENGTH"));
        if (options.frequencyAnalysisOptions().enabled()) {
            secondaryMetrics.add("WEIGHTED_SIMILARITY");
        }
        resultWriter.addJsonEntry(new ReportInformation(secondaryMetrics), REPORT_INFORMATION_FILE_NAME);
    }
