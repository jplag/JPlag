...
public class ReportObjectFactory {
    ...
    private static final RelativePath DISTRIBUTION_FILE_NAME = RelativePath.of("distribution.json");
    private static final RelativePath RUN_INFORMATION_FILE_NAME = RelativePath.of("runInformation.json");
    private static final RelativePath TOP_COMPARISONS_FILE_NAME = RelativePath.of("topComparisons.json");
    private static final RelativePath CLUSTER_FILE_NAME = RelativePath.of("cluster.json");
    private static final RelativePath SUBMISSION_MAPPINGS_FILE_NAME = RelativePath.of("submissionMappings.json");
    private static final RelativePath README_FILE_NAME = RelativePath.of("README.txt");
    private static final RelativePath OPTIONS_FILE_NAME = RelativePath.of("options.json");
    ...
    private static final RelativePath SUBMISSION_FILE_INDEX_FILE_NAME = RelativePath.of("submissionFileIndex.json");
    /** Version of the report viewer. **/
    public static final Version REPORT_VIEWER_VERSION = JPlag.JPLAG_VERSION;
    private static final RelativePath SUBMISSIONS_ROOT_PATH = RelativePath.of("files");
    ...
    private void copySubmissionFilesToReport(JPlagResult result) throws FileException {
        ...
        for (Submission submission : submissions) {
            for (Path file : submission.getFiles()) {
                RelativePath filePath = FilePathUtil.getRelativeSubmissionPath(file, submission, submissionToIdFunction);
                RelativePath resultPath = SUBMISSIONS_ROOT_PATH.resolve(filePath);
    ...
    private Path getFileToCopy(Language language, Path file) {
        return language.useViewFiles() ? PathUtils.appendSuffix(file, language.viewFileExtension()) : file;
    }
