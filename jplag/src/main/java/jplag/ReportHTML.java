 ...
 */
public class ReportHTML implements TokenConstants, IReport {
	...
	public ReportHTML(Program program, Language language) {
	...
	/* (non-Javadoc)
	 * @see jplag.IReport#write(java.io.File, int[], jplag.SortedVector, jplag.SortedVector, jplag.SortedVector, jplag.clustering.Cluster, jplag.options.Options)
	 */
	@Override
	...
	public void copyFixedFiles(File root) {
		...
		for (int i = fileList.length - 1; i >= 0; i--) {
			try {
				java.net.URL url = ReportHTML.class.getResource("data/" + fileList[i]);
