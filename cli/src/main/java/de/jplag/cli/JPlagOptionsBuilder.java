...
public class JPlagOptionsBuilder {
    ...
    private JPlagOptions initializeJPlagOptions(Set<File> submissionDirectories, Set<File> oldSubmissionDirectories, List<String> suffixes)
        ...
        return new JPlagOptions(this.cliInputHandler.getSelectedLanguage(), this.cliOptions.minTokenMatch, submissionDirectories,
                ...
                this.cliOptions.advanced.analyzeComments, this.cliOptions.frequencyOptions.frequency,
                this.cliOptions.frequencyOptions.frequencyStrategy, this.cliOptions.frequencyOptions.frequencyStrategyMinValue,
                this.cliOptions.frequencyOptions.weightingStrategy, this.cliOptions.frequencyOptions.weightingStrategyWeightingFactor);
    }
