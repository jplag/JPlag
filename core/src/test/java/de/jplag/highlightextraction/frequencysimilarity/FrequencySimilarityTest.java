...
// }
// completeMatchesStrategy.processMatchTokenTypes(extractMatchTokenTypes(comparison.matches().getFirst()),
// this::addSequenceKey,
// this::addSequence, 20);
// completeMatchesStrategy.processMatchTokenTypes(extractMatchTokenTypes(comparison.matches().getLast()),
// this::addSequenceKey,
// this::addSequence, 20);
// MatchWeighting weighting = new MatchWeighting(completeMatchesStrategy, frequencyMap);
// MatchFrequency matchFrequency = weighting.weightAllMatches(List.of(comparison.matches().getFirst(),
// comparison.matches().getLast()),
// submissionToken);
...
//
// // assertEquals(1.0, roundedResultProportional, 0.01, "proportional frequencySimilarity should have following weight
// at
// // 0.5: 1");
// // assertEquals(1.0, roundedResultLinear, 0.01, "linear frequencySimilarity should have following weight at 0.5: 1");
// // assertEquals(1.0, roundedResultQuadratic, 0.01, "quadratic frequencySimilarity should have following weight at
// 0.5:
// // 1");
// // assertEquals(1.0, roundedResultSigmoid, 0.01, "sigmoid frequencySimilarity should have following weight at 0.5:
// 1");
...
// // assertEquals(0.0, result5.get(1).similarity(), 0.01, "proportional frequencySimilarity should have following
// weight
// // at 0.5: 1");
// // assertEquals(0.0, result6.get(1).similarity(), 0.01, "linear frequencySimilarity should have following weight at
// 0.5:
// // 1");
// // assertEquals(0.0, result7.get(1).similarity(), 0.01, "quadratic frequencySimilarity should have following weight
// at
// // 0.5: 1");
