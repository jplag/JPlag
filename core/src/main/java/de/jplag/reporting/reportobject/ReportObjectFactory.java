...
public class ReportObjectFactory {
    ...
    public static final String SUBMISSION_FILE_INDEX_FOLDER_NAME = "submissionFileIndex";
    ...
    private void writeSubmissionIndexFile(JPlagResult result) {
        ...
        submissions.stream().forEach(submission -> {
            ...
            resultWriter.addJsonEntry(tokenCounts, Path.of(SUBMISSION_FILE_INDEX_FOLDER_NAME, submissionToIdFunction.apply(submission) + ".json"));
        });
    }
