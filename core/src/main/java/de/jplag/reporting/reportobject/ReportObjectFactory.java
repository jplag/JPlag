...
public class ReportObjectFactory {
    ...
    public static final Path DISTRIBUTION_FILE_NAME = Path.of("distribution.json");
    public static final Path RUN_INFORMATION_FILE_NAME = Path.of("runInformation.json");
    public static final Path TOP_COMPARISONS_FILE_NAME = Path.of("topComparisons.json");
    public static final Path CLUSTER_FILE_NAME = Path.of("cluster.json");
    public static final Path SUBMISSION_MAPPINGS_FILE_NAME = Path.of("submissionMappings.json");
    ...
    private void writeRunInformation(JPlagResult result) {
        RunInformation runInformation = new RunInformation(REPORT_VIEWER_VERSION, List.of(), getDate(), result.getDuration(),
