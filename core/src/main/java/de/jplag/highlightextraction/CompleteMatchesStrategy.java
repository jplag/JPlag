 ...
 * sequence is added to the isFrequencyAnalysisEnabled map without modification. So the Strategy counts all occurrences
 * of complete matches inside all the complete matches of the comparisons.
 */
public class CompleteMatchesStrategy implements FrequencyStrategy {
    /**
     * Adds the given token sequence to the map and updates its isFrequencyAnalysisEnabled.
    ...
    /**
     * Calculates the isFrequencyAnalysisEnabled of a match. According to the strategy.
