...
public class FrequencySimilarity {
    ...
    public double frequencySimilarity(JPlagComparison comparison, double weight) {
        ...
        int matchedFrequencyTokensOfFirst = getRareSigmoidTokensWeightedMatchLengthOfFirst(comparison, weight);//todo hier anpassen
        int matchedFrequencyTokensOfSecond = getRareSigmoidTokensWeightedMatchLengthOfSecond(comparison, weight);
 ...
 */
    ...
    public int getRareSigmoidTokensWeightedMatchLengthOfFirst(JPlagComparison comparison, double weight) {
        double maxFrequency = comparison.matches().stream()
                .mapToDouble(Match::getFrequencyWeight)
                .max()
                .orElse(1.0);
    ...
    public int getRareSigmoidTokensWeightedMatchLengthOfSecond(JPlagComparison comparison, double weight) {
        double maxFrequency = comparison.matches().stream()
                .mapToDouble(Match::getFrequencyWeight)
                .max()
                .orElse(1.0);
