  ...
  <div class="flex flex-col gap-1 overflow-hidden">
    <div class="h-full max-h-full flex-1 overflow-hidden">
      <div class="flex h-full max-h-full flex-col gap-5 overflow-hidden">
        ...
        >
          <CliViewCategory class="col-start-1 row-start-1 h-full min-h-fit">
          ...
          <CliViewCategory class="col-start-2 row-start-1 h-full min-h-fit">
          ...
          <CliViewCategory class="col-span-2 row-start-2 h-fit">
          ...
          <CliViewCategory class="col-span-2 row-start-4 h-fit" :show-content="showAdvancedOptions">
            <template #heading>
