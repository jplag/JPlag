...
/** See https://svn.ipd.kit.edu/trac/de/jplag/ticket/58 */
public class Bug58 {
	...
	/**
	 * Uses the actual parser component (not only the antlr parser but the de.jplag
	...
	private void parseWithActualParser(File file) {
		...
		parser.setProgram(new de.jplag.StrippedProgram());
