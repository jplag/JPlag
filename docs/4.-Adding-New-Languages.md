...
Make sure to include the license of the grammar used in a file called GRAMMAR-LICENSE next to the antlr files. This ensures they are part of our binary distribution.
