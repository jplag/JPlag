...
Make sure to include the license of the grammar used in a file called LICENSE next to the ANTLR files. This ensures they are part of our binary distribution.
...
public class TestLanguage extends AbstractAntlrLanguage {
    ...
    public String getName() {
        return "Test"; //return the name of the language (e.g. Java). Can be anything that describes the language module shortly
    }
