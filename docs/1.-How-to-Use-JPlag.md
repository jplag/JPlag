...
Highlight Extraction
      --frequency-strategy=<{COMPLETE_MATCHES, CONTAINED_MATCHES, SUB_MATCHES, WINDOW_OF_MATCHES}>
                        Strategy for determining match frequency during comparison.
                          COMPLETE_MATCHES: Only identical Matches across Comparisons.
                          CONTAINED_MATCHES: Also count Matches that are included in others.
                          SUB_MATCHES: Also includes smaller Sub-Matches.
                          WINDOW_OF_MATCHES: Considers all Sub-Matches of window size.
                          
      --frequency-strategy-min=<minCount>
                        Minimum length of (Sub-)Match to be considered
