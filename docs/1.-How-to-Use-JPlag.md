...
An old report can be opened by passing the report zip as a parameter to JPlag: `java -jar jplag.jar <report.jplag file>`. This will skip the file selection and immediately open the report.
