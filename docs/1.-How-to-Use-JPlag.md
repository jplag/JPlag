...
Frequency Analysis
      ...
      --isFrequencyAnalysisEnabled-min-value=<frequencyStrategyMinValue>
                        Minimum weight to use for matches in frequency
                        analysis (default: 0.01 for PROPORTIONAL, 1.0 for others)
      --isFrequencyAnalysisEnabled-strategy=<{PROPORTIONAL, LINEAR,
        QUADRATIC, SIGMOID}>
                        Strategy for frequency weighting.
      --weighting-factor=<weightingStrategyWeightingFactor>
                        Factor by which the frequency weight is multiplied
                        (default: 1.0)
Languages:
  c
  cpp
