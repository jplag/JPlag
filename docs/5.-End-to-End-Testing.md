...
To create the test data, some examples from scientific literature that have addressed the concealment of plagiarism were used to ensure the greatest possible coverage of the JPlag functionality. 
...
These elaborations provide basic ideas on how modifying the plagiarized source code can look or be adapted.
