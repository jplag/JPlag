...
public class JPlagTestSuiteHelper {
	...
	/**
	 * Creates a unique identifier from the submissions in the JPlagComparison
	 * object which is used to find the results in the json files.
	 * 
	...
	public static String getTestIdentifier(JPlagComparison jPlagComparison) {
		...
		String testFileNamesInFirstSubmission = FileHelper
				.getEnclosedFileNamesFromCollection(jPlagComparison.getFirstSubmission().getFiles());
		String testFileNamesInSecondSubmission = FileHelper
				.getEnclosedFileNamesFromCollection(jPlagComparison.getSecondSubmission().getFiles());
