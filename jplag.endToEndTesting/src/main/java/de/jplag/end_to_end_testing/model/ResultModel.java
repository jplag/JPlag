...
/**
 * The ResultModel contains all information and comparison values that are
 * important for a test and that could be parsed from the json file.
 */
public class ResultModel {
	 ...
	 * file in the form of a Java object.
	 * 
	 * @param resultSimilarity stored comparative value of the similarity
	 * @param testIdentifier   specifies which associated test results are needed
