...
public class TestCaseModel {
	...
	/**
	 * creates the JPlag options for the test run from the values passed in the
	 * constructor.
	 * 
	 * @return current JPlag options for the created object
	 */
	public JPlagOptions getJPlagOptionsFromCurrentModel() {
		return new JPlagOptions(new ArrayList<String>(Arrays.asList(submissionFolderPath)), new ArrayList<String>(),
				languageOption);
	}
}
