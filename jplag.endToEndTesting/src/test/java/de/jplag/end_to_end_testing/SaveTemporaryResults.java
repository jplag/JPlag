...
class SaveTemporaryResults {
	...
	private void insertNewTestResultsIntoJsonStore(LanguageOption languageOption)
		...
		File[] fileArrayFromTemporaryResultPath = TestDirectoryConstants.TEMPORARY_RESULT_PATH_MAPPER()
				.get(languageOption).toFile().listFiles();
